...
#for pindex in range(2):
    ...
    name_string = "$normal$, " + dis_type + ", " + data_type + ", $n=$" + str(n) + ", $p=$" + str(prange[pindex]) + ", $q=$" + str(qrange[qindex]) + ", $r=$" + str(rrange[rindex])
    #name_string = "$normal$, " + dis_type + ", " + data_type + ", $n=$" + str(n) + ", $p=$" + str(prange[pindex]) + ", $q=$" + "p" + ", $r=$" + str(rrange[rindex])
